...
- **Available Scopes**: `feat`, `fix`, `theme`, `components`, `sections`, `templates`, `assets`, `customer`, `checkout`, `header`, `footer`, `product`, `cart`, `testing`, `configuration`, `documentation`, `locales`, `snippets`, `hydrogen`
...
| ... | See workflow.config.json for all 19 scopes |
...
📄 [See full details](../guidelines/ACCESSIBILITY_STANDARDS.md)
...
📄 [See full details](../guidelines/BLUEPRINT_CREATION_GUIDE.md)
...
📄 [See full details](../guidelines/CONTEXT_PRESERVATION.md)
